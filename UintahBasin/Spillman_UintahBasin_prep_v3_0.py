...
#export_shapefiles_select_fields("UintahBasin_CP_MP", out_folder_spillman, milepost_fields)
#export_shapefiles_select_fields("UintahBasinStreets", out_folder_spillman, street_fields)
